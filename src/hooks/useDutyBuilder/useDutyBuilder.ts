...
import { DefFuctionType, Duties } from "../../models"
import { _DutyBuilderDefaultScheme, _DutyBuilderItemType, Duty_AB,
  Duty_BGN,Duty_DB,Duty_GG,Duty_GGBN,Duty_GP,Duty_GT,Duty_HBN,Duty_IG,Duty_IP,Duty_NA,Duty_NB,Duty_NL,Duty_NN,Duty_Operator,Duty_PARK,Duty_ROTA } from "./types"
...
const useDutyBuilder = () => {
  ...
  const _setDefaultPerson = (type: Duties) => {
    return {
      personData: oficers[0],
      personId: oficers[0].id,
      type
    }
  }
