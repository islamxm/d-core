import { Duty_IP } from "../../../../../../hooks/useDutyBuilder/types";
...
const Duty_IP_Component:DutyGroupItemComponent<Duty_IP> = ({
  data,
  index
}) => {
  const {
        ...
        <Row gutter={[5, 5]}>
          <Col span={24}>
            <div className={styles.group}>
              <Row gutter={[5, 5]}>
                <Col span={24}>
                  <div className={styles.title}>Patrul serkerdesi</div>
                </Col>
                <Col span={24}>
                  <div className={styles.body}>
                    {
                      body?.ulusy?.personData ? (
                        ...
                        defaultValue={body.ulusy.personId}
                          ...
                          onDelete={() => dispatch(dutyActions.onChangePerson({groupIndex: index, body: {...body, ulusy: {type: Duties['Içerki patrul serkerdesi']}}}))}
                          />
                      ) : (
                        <Button onClick={() => {
                          dispatch(dutyActions.onChangePerson({groupIndex: index, body: {...body, ulusy: dutyBuilder._setDefaultPerson(Duties['Içerki patrul serkerdesi'])}}))
                ...
                <Col span={24}>
                  <div className={styles.body}>
                    <Row gutter={[3, 3]}>
                    {
                     ...
                     <Col><Button onClick={() => dispatch(dutyActions.onChangePerson({groupIndex: index, body: {...body,patrullar: [...body.patrullar, dutyBuilder._setDefaultPerson(Duties['Içerki patrul'])]}}))} colorVariant='success' iconButton={{isRound: true, size: 'md'}}><AiOutlinePlus/></Button></Col>
                    </Row>
                  </div>
                </Col>
              </Row>
...
export default Duty_IP_Component;