import { Duty_NL } from "../../../../../../hooks/useDutyBuilder/types";
...
const Duty_NL_Component:DutyGroupItemComponent<Duty_NL> = ({
  data,
  index
}) => {
  const {
                  ...
                  <div className={styles.body}>
                  {
                      body?.personData ? (
                        ...
                        defaultValue={body.personId}
                          ...
                          onDelete={() => dispatch(dutyActions.onChangePerson({groupIndex: index, body: {type: Duties['Nobatçy lukman']}}))}
                          />
                      ) : (
                        <Button onClick={() => {
                          dispatch(dutyActions.onChangePerson({groupIndex: index, body: dutyBuilder._setDefaultPerson(Duties['Nobatçy lukman'])}))
...
export default Duty_NL_Component;